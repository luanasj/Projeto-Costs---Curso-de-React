...
function handleCategory(e){
    ...
    <form className={styles.form} onSubmit={submit}>
        ...
        <Input type="number" text="Orçamento do Projeto" name="budget" placeholder="Insira o nome orçamento total" handleOnChange={handleChange} value={project.budget ? project.budget : ''}/>
